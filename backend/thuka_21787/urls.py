...
admin.site.site_header = "THUKA"
admin.site.site_title = "THUKA Admin Portal"
admin.site.index_title = "THUKA Admin"

# swagger
api_info = openapi.Info(
    title="THUKA API",
    default_version="v1",
    description="API documentation for THUKA App",
)
